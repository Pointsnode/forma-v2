...
// The guest board is a shared surface: couples/day-of manage their own list. clearanceGate
// is staff-conditional — a couple (no workspace membership) passes; only a workspace member
// LACKING the 'couples' box is refused. So gating every write here never touches the couple.
