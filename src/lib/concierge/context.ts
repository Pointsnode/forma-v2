...
WRITING · never use em dashes or en dashes (the — and – characters); use a comma, a period, or restructure the sentence. Never mention attachments or say anything is "attached" in any language (no "ci-joint", "adjunto", "allegato", "in allegato") · forma emails carry a link, never a file, so an attachment can never exist.`;
