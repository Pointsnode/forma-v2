          ...
          <div className="relative flex max-h-[86vh] w-full max-w-[560px] flex-col rounded-[18px] bg-paper p-7 shadow-hero">
            ...
            {picked ? (
              <div className="mt-4 overflow-y-auto">
                <button onClick={() => setPicked(null)} className="mb-2 text-[12.5px] text-muted hover:text-ink">← {t("backToCatalogue")}</button>
                <p className="font-display text-[18px] text-ink">{picked.name}</p>
              ...
              <div className="mt-4 overflow-y-auto">
                <button onClick={() => { setAdding(false); router.refresh(); }} className="mb-3 text-[12.5px] text-muted hover:text-ink">← {t("backToCatalogue")}</button>
              ...
              <>
                ...
                <button onClick={() => setAdding(true)} className="mt-3 border-t border-hairline pt-3 text-left text-[13px] text-taupe hover:text-ink">{t("notInCatalogue")}</button>
              </>
            )}
          </div>
        </div>
